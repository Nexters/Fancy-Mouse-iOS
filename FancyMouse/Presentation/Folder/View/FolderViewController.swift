...
//  FancyMouse
//
//  Created by suding on 2022/02/11.
//
...
final class FolderViewController: UIViewController {
    ...
    private lazy var pasteImage: UIImageView = {
    ...
    private func configureUI() {
        ...
        self.emojiView.addSubview(self.pasteImage)
        pasteImage.snp.makeConstraints { make in
        ...
        self.emojiView.addSubview(self.folderImage)
        self.folderImage.snp.makeConstraints { make in
        ...
        self.pasteButton.snp.makeConstraints { make in
            make.top.equalTo(webExplainLabel.snp.bottom).offset(16)
            make.leading.equalToSuperview().inset(24)
            make.trailing.equalTo(folderImage.snp.leading).offset(140)
        }
...
extension FolderViewController : UICollectionViewDelegate, UICollectionViewDelegateFlowLayout, UICollectionViewDataSource {
    ...
    func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        guard let cell = collectionView.dequeueReusableCell(withReuseIdentifier: FolderCell.identifier,
    ...
    func collectionView(_ collectionView: UICollectionView, layout collectionViewLayout: UICollectionViewLayout,
        ...
        let myWidth : CGFloat = self.folderCollectionView.frame.width / 2 - itemSpacing
        return CGSize(width: myWidth, height: myWidth * 0.917)
     }
}
